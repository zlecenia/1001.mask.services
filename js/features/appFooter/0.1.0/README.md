...
node tools/dev/componentDevServer.js js/features/appFooter/0.1.0 3001
```
...
### Integration Usage
```javascript
import appFooter from './js/features/appFooter/0.1.0/index.js';

// Initialize component
const result = await appFooter.init(context);

// Use component
if (appFooter.component) {
  // Vue component available
  const VueComponent = appFooter.component;
}

// Handle actions
const response = appFooter.handle({
  action: 'render',
  data: { /* your data */ }
});
```
...
│   ├── appFooter.js              # Vue component ✅
│   ├── appFooter.test.js         # Component tests ✅
...
- Key properties: `systemInfo`, `deviceInfo`, `buildInfo`, ...
...
- Key properties: `updateInterval`, `enableCaching`, `lazyLoading`, ...
...
4. Test changes with `npm run component:dev:appFooter`
...
**Generated**: 2025-09-27T07:16:41.988Z  
**Generator**: componentReadmeGenerator v1.0.0  
**Component**: appFooter@0.1.0
