#!/usr/bin/env node
/**
 * Development server for realtimeSensors component
...
async function startDevServer() {
  try {
    const server = await createServer({
      ...
      define: {
        __COMPONENT_NAME__: JSON.stringify('realtimeSensors'),
    ...
    console.log('\n🚀 realtimeSensors Dev Server Started');
    console.log('📱 Preview: http://localhost:3001/standalone.html');
    console.log('🔧 Component: realtimeSensors v0.1.0');
