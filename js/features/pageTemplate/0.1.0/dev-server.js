#!/usr/bin/env node
/**
 * Development server for pageTemplate component
...
async function startDevServer() {
  try {
    const server = await createServer({
      ...
      define: {
        __COMPONENT_NAME__: JSON.stringify('pageTemplate'),
    ...
    console.log('\n🚀 pageTemplate Dev Server Started');
    console.log('📱 Preview: http://localhost:3001/standalone.html');
    console.log('🔧 Component: pageTemplate v0.1.0');
