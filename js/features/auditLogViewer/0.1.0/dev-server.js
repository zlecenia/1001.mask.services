#!/usr/bin/env node
/**
 * Development server for auditLogViewer component
...
async function startDevServer() {
  try {
    const server = await createServer({
      ...
      define: {
        __COMPONENT_NAME__: JSON.stringify('auditLogViewer'),
    ...
    console.log('\n🚀 auditLogViewer Dev Server Started');
    console.log('📱 Preview: http://localhost:3001/standalone.html');
    console.log('🔧 Component: auditLogViewer v0.1.0');
