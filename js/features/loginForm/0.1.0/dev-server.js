#!/usr/bin/env node
/**
 * Development server for loginForm component
...
async function startDevServer() {
  try {
    const server = await createServer({
      ...
      define: {
        __COMPONENT_NAME__: JSON.stringify('loginForm'),
    ...
    console.log('\n🚀 loginForm Dev Server Started');
    console.log('📱 Preview: http://localhost:3001/standalone.html');
    console.log('🔧 Component: loginForm v0.1.0');
